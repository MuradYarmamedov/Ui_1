...
class ViewController: UIViewController {
    ...
    private lazy var categoryStack: UIStackView = {
        ...
        view.distribution = .equalSpacing
        view.spacing = 16
        self.categoryScroll.addSubview(view)
...
//        view.addSubview(horizontalStack)
    ...
    lazy var horizontalStack: UIStackView = {
        ...
        self.horizontalScroll.addSubview(view)
...
//        view.backgroundColor = .systemGray6
    ...
    override func viewDidLoad() {
        ...
        self.hello.snp.makeConstraints { make in
            make.left.equalTo(self.rootsStackView.snp.left)
        ...
        self.categoryStack.snp.makeConstraints { make in
            ...
            make.right.equalTo(self.categoryScroll.contentLayoutGuide.snp.right).offset(-16)
        ...
        self.horizontalStack.snp.makeConstraints { make in
            ...
            make.right.equalTo(self.horizontalScroll.contentLayoutGuide.snp.right).offset(-16)
